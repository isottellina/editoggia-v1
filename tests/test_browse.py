...
class TestBrowse(EditoggiaTestCase):
    ...
    def test_collection_title(self):
        ...
        self.assert200(rv)
        self.assertTrue(
            rv.data.find(least_title.encode()) < rv.data.find(most_title.encode())
        )
    ...
    def test_collection_author(self):
        ...
        self.assert200(rv)
        self.assertTrue(
            rv.data.find(least_author.title.encode())
            < rv.data.find(most_author.title.encode())
        )
    ...
    def test_collection_date_updated(self):
        ...
        self.assert200(rv)
        self.assertTrue(
            rv.data.find(stories[1].title.encode())
            < rv.data.find(stories[0].title.encode())
        )
    ...
    def test_collection_included_fandoms(self):
        ...
        # Add fandom to story
        stories[1].update(fandom=[self.fandom, other_fandom])
