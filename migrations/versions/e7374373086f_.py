...
Revision ID: e7374373086f
Revises: 
Create Date: 2020-05-11 00:56:18.893392
...
def upgrade():
    ...
    sa.Column('gender', sa.Enum('Woman', 'Man', 'Other', "Doesn't want to say"), nullable=True),
