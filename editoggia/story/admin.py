...
admin.add_view(
    EditoggiaModelView(Fandom, db.session, category="Stories", endpoint="admin_fandom")
)

admin.add_view(StoryView(Story, db.session, category="Stories", endpoint="admin_story"))

admin.add_view(
    EditoggiaModelView(
        Chapter, db.session, category="Stories", endpoint="admin_chapter"
    )
)

admin.add_view(
    EditoggiaModelView(Tag, db.session, category="Stories", endpoint="admin_tag")
)

admin.add_view(
    EditoggiaModelView(
        Comment, db.session, category="Stories", endpoint="admin_comment"
    )
)
